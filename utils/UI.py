...
class PolygonEditorWindow(QMainWindow):
    def __init__(self):
        ...
        first_frame = self.get_first_frame(video_path)
        ...
        self.run_button.clicked.connect(lambda: self.run_video_processor(video_path))
    ...
    def run_video_processor(self, video_path):
        zone_in_polygons = []
        zone_out_polygons = []
